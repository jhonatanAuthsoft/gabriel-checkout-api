...
public class UsuarioController {
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'FUNCIONARIO')")
    @PostMapping("/reenviar-senha/{idUsuario}")
    public ResponseEntity<Boolean> reenviarSenha(@PathVariable Long idUsuario) {
        return new ResponseEntity<>(this.usuarioService.reenviarSenha(idUsuario), HttpStatus.OK);
    }
